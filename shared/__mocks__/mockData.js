      ...
      },
      {
        ...
        properties: {
          ...
          input_id: {
            type: 'text',
            required: false,
            default: '43dbbfac-c7d3-4827-a123-3a647f87e9d4',
            options: null,
      ...
      },
      {
        ...
        properties: {
          ...
          input_id: {
            type: 'text',
            required: false,
            default: 'b4c05030-061a-4b66-88f4-a20f27e0caf3',
            options: null,
            description: 'Randomly generated uuid for a form input to associate it with a label.',
            related_to: null,
            editor_type: 'short-text-editor',
      ...
      },
      {
        ...
        properties: {
          ...
          input_id: {
            type: 'text',
            required: false,
            default: '435c09b7-d2b6-4cab-8e44-094bbdfef9a8',
            options: null,
            description: 'Randomly generated uuid for a form input to associate it with a label.',
            related_to: null,
            editor_type: 'short-text-editor',
      ...
      },
      {
        ...
        properties: {
          ...
          input_id: {
            type: 'text',
            required: false,
            default: 'c5aaf5a2-2adc-4bf3-b282-52b1194ff4dd',
            options: null,
            description: 'Randomly generated uuid for a form input to associate it with a label.',
            related_to: null,
            editor_type: 'short-text-editor',
      ...
      },
      {
        ...
        properties: {
          ...
          input_id: {
            type: 'text',
            required: false,
            default: 'd4276523-c0b8-478d-8c58-157bb20de17b',
            options: null,
            description: 'Randomly generated uuid for a form input to associate it with a label.',
            related_to: null,
            editor_type: 'short-text-editor',
