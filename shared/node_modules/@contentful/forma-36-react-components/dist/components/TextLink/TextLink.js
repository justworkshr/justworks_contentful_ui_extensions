...
function (_Component) {
  ...
  (0, _createClass2.default)(TextLink, [{
    ...
    value: function render() {
      ...
      var content = _react.default.createElement(_TabFocusTrap.default, null, icon && iconPosition === 'left' && this.renderIcon(icon, linkType), text || children, icon && iconPosition === 'right' && this.renderIcon(icon, linkType));
