...
var Heading = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2["default"])(Heading, [{
    ...
    value: function render() {
      ...
      var classNames = (0, _classnames["default"])(styles['Heading'], className);
      var Element = element;
      return /*#__PURE__*/_react["default"].createElement(_Typography.TypographyContext.Consumer, null, function (value) {
        return /*#__PURE__*/_react["default"].createElement(Element, (0, _extends2["default"])({
          className: (0, _classnames["default"])(classNames, [value['heading'] && "f36-margin-bottom--".concat(value['heading']['spacing'])]),
          "data-test-id": testId
        }, otherProps), children);
      });
    }
...
(0, _defineProperty2["default"])(Heading, "propTypes", {
...
(0, _defineProperty2["default"])(Heading, "defaultProps", defaultProps);
