...
function WorkbenchHeader(props) {
  ...
  }, props.onBack ? _react.default.createElement("div", {
  ...
  }, props.icon) : null, props.title && _react.default.createElement("div", {
    "data-test-id": "workbench-title",
    className: styles['Workbench__header-title']
  }, typeof props.title === 'string' ? _react.default.createElement(_Heading.default, {
    className: styles['Workbench__header-title__heading']
  }, props.title) : props.title), props.description && _react.default.createElement("div", {
    "data-test-id": "workbench-description",
    className: styles['Workbench__header-description']
  }, typeof props.description === 'string' ? _react.default.createElement("span", {
    className: styles['Workbench__header-description__text']
  }, props.description) : props.description), props.actions ? _react.default.createElement("div", {
...
function (_Component) {
  ...
  function Workbench() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Workbench).apply(this, arguments));
  }
...
(0, _defineProperty2.default)(Workbench, "propTypes", {
  className: _propTypes.default.string,
  children: _propTypes.default.node,
  testId: _propTypes.default.string
});
(0, _defineProperty2.default)(Workbench, "defaultProps", defaultProps);
(0, _defineProperty2.default)(Workbench, "Header", WorkbenchHeader);
(0, _defineProperty2.default)(Workbench, "Content", WorkbenchContent);
(0, _defineProperty2.default)(Workbench, "Sidebar", WorkbenchSidebar);
