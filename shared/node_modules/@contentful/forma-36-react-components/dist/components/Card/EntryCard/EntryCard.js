...
var _CardDragHandle = _interopRequireDefault(require("../CardDragHandle/CardDragHandle"));
...
function (_Component) {
  ...
  function EntryCard() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(EntryCard)).call.apply(_getPrototypeOf2, [this].concat(args)));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "state", {
      isDropdownOpen: false
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderTitle", function (title) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderDescription", function (description) {
      var truncatedDescription = (0, _truncate.default)(description, 95, {});
      return _react.default.createElement("p", {
        className: styles.EntryCard__description
      }, truncatedDescription);
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderThumbnail", function (thumbnailElement) {
  ...
  (0, _createClass2.default)(EntryCard, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          otherProps = (0, _objectWithoutProperties2.default)(_this$props2, ["className", "title", "onClick", "testId", "description", "contentType", "status", "statusIcon", "thumbnailElement", "loading", "dropdownListElements", "isDragActive", "size", "cardDragHandleComponent", "cardDragHandleProps", "withDragHandle"]);
      var classNames = (0, _classnames.default)(styles.EntryCard, (_cn = {}, (0, _defineProperty2.default)(_cn, styles['EntryCard--drag-active'], isDragActive), (0, _defineProperty2.default)(_cn, styles["EntryCard--size-".concat(size)], size), _cn), className);
      ...
      }, _react.default.createElement(_EntryCardSkeleton.default, null)) : _react.default.createElement(_react.default.Fragment, null, this.renderCardDragHandle(), _react.default.createElement("article", {
        className: styles.EntryCard__wrapper
      ...
      }, contentType), statusIcon && _react.default.createElement(_Icon.default, {
        icon: statusIcon,
        color: "muted",
      ...
      }, dropdownListElements)), _react.default.createElement("div", {
        className: styles.EntryCard__content
      }, _react.default.createElement("div", {
        className: styles.EntryCard__body
      }, title && this.renderTitle(title), description && size === 'default' && this.renderDescription(description)), thumbnailElement && size === 'default' && this.renderThumbnail(thumbnailElement))))));
    }
  }]);
  return EntryCard;
}(_react.Component);
...
(0, _defineProperty2.default)(EntryCard, "propTypes", {
  ...
  size: _propTypes.default.oneOf(['default', 'small']).isRequired
});
(0, _defineProperty2.default)(EntryCard, "defaultProps", defaultProps);
