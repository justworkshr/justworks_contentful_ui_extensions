...
export declare type EntryCardPropTypes = {
    /**
...
export declare class EntryCard extends Component<EntryCardPropTypes> {
    ...
    renderThumbnail: (thumbnailElement: React.ReactNode) => JSX.Element;
    renderStatus: (status: "published" | "draft" | "archived" | "changed") => JSX.Element;
