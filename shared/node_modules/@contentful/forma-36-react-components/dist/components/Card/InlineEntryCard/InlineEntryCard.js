...
function (_Component) {
  ...
  function InlineEntryCard() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(InlineEntryCard).apply(this, arguments));
  }
  ...
  (0, _createClass2.default)(InlineEntryCard, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          otherProps = (0, _objectWithoutProperties2.default)(_this$props, ["className", "dropdownListElements", "isSelected", "children", "testId", "isLoading", "status"]);
      ...
      }, _react.default.createElement(_InlineEntryCardSkeleton.default, null))), _react.default.createElement("div", {
        className: statusIndicatorClassNames
      }), _react.default.createElement("span", {
        className: styles['InlineEntryCard__text-wrapper']
      }, isLoading ? 'Loading' : children), dropdownListElements && _react.default.createElement(_CardActions.default, {
