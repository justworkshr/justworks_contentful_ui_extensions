...
function (_Component) {
  ...
  function CardDragHandle() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(CardDragHandle).apply(this, arguments));
  }
...
(0, _defineProperty2.default)(CardDragHandle, "propTypes", {
  children: _propTypes.default.node.isRequired,
  className: _propTypes.default.string,
  testId: _propTypes.default.string,
  isDragActive: _propTypes.default.bool
});
(0, _defineProperty2.default)(CardDragHandle, "defaultProps", defaultProps);
