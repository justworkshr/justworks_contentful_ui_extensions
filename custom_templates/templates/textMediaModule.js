import { constructRole, allowAsset, defaultStyleTypes, fieldObject } from '../utils';
  ...
  [c.TEXT_MEDIA_MODULE]: {
    ...
    fieldRoles: {
      left_content: constructRole({
        ...
        field: fieldObject({type: c.FIELD_TYPE_MARKDOWN, defaultClasses: 'text-left text-black'}),
