  ...
  data: [
    ...
    },
    {
      meta: {
        ...
        styleguide_path: '/styleguide/components%2Fbase_lead_form',
        editor_role: 'component',
        tags: ['form']
      },
      properties: {
    ...
    },
    {
      ...
      properties: {
        ...
        xl_config: {
          ...
          required: false,
          default: 'card',
          options: ['card', 'card-no-description', 'inline', 'inline-no-description', 'text-only'],
          description: null,
          related_to: null,
          hidden: false
        },
    ...
    },
    {
      meta: {
        ...
        styleguide_path: '/styleguide/conversion_modal_content',
        editor_role: 'component',
        tags: ['cta', 'action'],
        extension_of: null
      },
    ...
    },
    {
      meta: {
        ...
        styleguide_path: '/styleguide/components%2Fdropdown_selectable_components',
        editor_role: 'component',
        tags: ['collection'],
        extension_of: null
      },
    ...
    {
      meta: {
        description: 'A 2-col wide grid which converts resources into configurable resource cards.',
    ...
    },
    {
      meta: {
        ...
        styleguide_path: '/styleguide/patterns%2Fstacked_hero_text',
        editor_role: 'singleton',
        tags: ['text']
      },
      properties: {
    ...
    },
    {
      meta: {
        ...
        styleguide_path: '/styleguide/patterns%2Fhero_double_stack_component',
        editor_role: 'pattern'
      },
      properties: {
        classname: {
